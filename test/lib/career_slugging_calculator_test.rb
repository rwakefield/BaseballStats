...
describe 'CareerSluggingCalculator' do
  describe '#calculate_career_slugging_percentage' do
    it 'will return the career at bats / career hits with three decimal places' do
      ...
      expected_result = ((1 + 2 + 3 + 4).to_f / 15.0).round(3)
      tester.calculate_career_slugging_percentage.must_equal expected_result
    end
    ...
    it 'will return 0.000 if there career at bats is 0' do
      ...
      tester.calculate_career_slugging_percentage.must_equal 0.000
    end
